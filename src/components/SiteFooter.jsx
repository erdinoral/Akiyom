...
const SiteFooter = ({ onContactClick, onTermsClick, showWhatsApp = true }) => (
  <footer className="footer">
    <div className="footer-container">
      <div className="footer-copyright">© 2026 Akiyom. Tüm hakları saklıdır.</div>
      <div className="footer-links">
        <Link to="/biz-kimiz" className="footer-link">
          Biz Kimiz
        </Link>
        ...
        {onContactClick ? (
          ...
          <a href="mailto:akiyom.iletisim@gmail.com" className="footer-link">
            İletişim
          </a>
        )}
        {showWhatsApp && (
          <a href={WHATSAPP_HREF} target="_blank" rel="noopener noreferrer" className="footer-whatsapp-link">
